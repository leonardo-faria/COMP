...
com_frequency: FREQUENCY EQUALS COM_FREQUENCY;
...
closed: CLOSED EQUALS BOOL;
transparent: TRANSPARENT EQUALS BOOL;
red: RED EQUALS INT255;
green: GREEN EQUALS INT255;
blue: BLUE EQUALS INT255;
...
taxiway_type: TYPE EQUALS QUOTE TAXYWAYTYPE_VAL QUOTE;
...
parking_type: TYPE EQUALS PARKING_TYPE;
parking_name: NAME EQUALS PARKING_NAME;
